...
export const SubcontractSearch = (props: Props) => {
    ...
    const [searchResults, setSearchResults] = useState<SubcontractorDataType[]>([]);
    ...
    const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const results: SubcontractorDataType[] = subcontractor_data.filter(
            (result) =>
                result.subcontractorName.toLowerCase().includes(term.toLowerCase())
        );
    ...
    const handleResultClick = (result: SubcontractorDataType) => {
        ...
        subcontractItem.onAddTempSubcontractorItem(result);
