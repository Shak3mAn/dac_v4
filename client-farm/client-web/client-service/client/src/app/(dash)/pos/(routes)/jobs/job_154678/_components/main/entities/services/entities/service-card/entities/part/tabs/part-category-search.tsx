...
export const PartCategorySearch = (props: Props) => {
    ...
    const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const results: InventoryItem[] = inv_data.filter(
            (result) =>
                result.itemCategory.toLowerCase().includes(term.toLowerCase())
        );
    ...
    const handleResultClick = (result: InventoryItem) => {
        setSearchTerm(result.itemCategory);
        setShowDropdown(false);
        ...
        toast({
            ...
            description: `Category: ${result.itemCategory}`,
        })
    }
    return (
        <div>
